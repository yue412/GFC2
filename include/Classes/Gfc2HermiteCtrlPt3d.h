#ifndef GFC2HERMITECTRLPT3D_H
#define GFC2HERMITECTRLPT3D_H
...
class GFCCLASSES_API Gfc2HermiteCtrlPt3d: public glodon::objectbuf::Entity
{
OBJECTBUF_DEC_OBJECT(Gfc2HermiteCtrlPt3d,glodon::objectbuf::Entity)
public:
    Gfc2HermiteCtrlPt3d();
    ...
    Gfc2Vector3d* getTangentPtr() const {return (Gfc2Vector3d*)m_pDocument->find(getTangent());}
...
class GFCCLASSES_API Gfc2HermiteCtrlPt3dFieldCacheInitializer: public glodon::objectbuf::FieldCacheInitializer
{
OBJECTBUF_DEC_OBJECT(Gfc2HermiteCtrlPt3dFieldCacheInitializer,glodon::objectbuf::FieldCacheInitializer)
public:
