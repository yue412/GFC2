...
class GFCCLASSES_API Gfc2ObjectFieldCacheInitializer: public glodon::objectbuf::FieldCacheInitializer
{
OBJECTBUF_DEC_OBJECT(Gfc2ObjectFieldCacheInitializer,glodon::objectbuf::FieldCacheInitializer)
public:
