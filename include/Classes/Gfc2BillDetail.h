...
class GFCCLASSES_API Gfc2BillDetail: public glodon::objectbuf::Entity
{
OBJECTBUF_DEC_OBJECT(Gfc2BillDetail,glodon::objectbuf::Entity)
public:
    Gfc2BillDetail();
...
class GFCCLASSES_API Gfc2BillDetailFieldCacheInitializer: public glodon::objectbuf::FieldCacheInitializer
{
OBJECTBUF_DEC_OBJECT(Gfc2BillDetailFieldCacheInitializer,glodon::objectbuf::FieldCacheInitializer)
public:
