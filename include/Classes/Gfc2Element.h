...
{
OBJECTBUF_DEC_OBJECT(Gfc2Element,glodon::objectbuf::Entity)
public:
    Gfc2Element();
    ...
    Gfc2ElementShape* getShapesPtr(int nIndex) const {return (Gfc2ElementShape*)m_pDocument->find(getShapes(nIndex));}
