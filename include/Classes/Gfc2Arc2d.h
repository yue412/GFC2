...
class GFCCLASSES_API Gfc2Arc2dFieldCacheInitializer: public glodon::objectbuf::FieldCacheInitializer
{
OBJECTBUF_DEC_OBJECT(Gfc2Arc2dFieldCacheInitializer,glodon::objectbuf::FieldCacheInitializer)
public:
