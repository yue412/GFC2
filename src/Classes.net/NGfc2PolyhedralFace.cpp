...
void NGfc2PolyhedralFace::addLoops(glodon::objectbuf::EntityRef nValue)
{
    ((Gfc2PolyhedralFace*)m_pEntity)->addLoops(nValue);
}

glodon::objectbuf::EntityRef NGfc2PolyhedralFace::getLoops(int nIndex)
{
...
void NGfc2PolyhedralFace::setPlane(glodon::objectbuf::EntityRef nValue)
{
    ((Gfc2PolyhedralFace*)m_pEntity)->setPlane(nValue);
}

glodon::objectbuf::EntityRef NGfc2PolyhedralFace::getPlane()
{
