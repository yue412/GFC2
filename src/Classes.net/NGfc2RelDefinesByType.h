...
public:
    ...
    void setRelatingType(glodon::objectbuf::EntityRef nValue);
    glodon::objectbuf::EntityRef getRelatingType();
    bool hasRelatingType();
    NGfc2ElementType^ getRelatingTypePtr();
    int getRelatingElementCount();
    void clearRelatingElement();
    void addRelatingElement(glodon::objectbuf::EntityRef nValue);
    glodon::objectbuf::EntityRef getRelatingElement(int nIndex);
