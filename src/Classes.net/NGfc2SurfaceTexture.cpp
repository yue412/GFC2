...
void NGfc2SurfaceTexture::setImageFileName(glodon::objectbuf::EntityRef nValue)
{
    ((Gfc2SurfaceTexture*)m_pEntity)->setImageFileName(nValue);
}

glodon::objectbuf::EntityRef NGfc2SurfaceTexture::getImageFileName()
{
...
void NGfc2SurfaceTexture::setTranfromsMatirx(glodon::objectbuf::EntityRef nValue)
{
    ((Gfc2SurfaceTexture*)m_pEntity)->setTranfromsMatirx(nValue);
}

glodon::objectbuf::EntityRef NGfc2SurfaceTexture::getTranfromsMatirx()
{
...
void NGfc2SurfaceTexture::addParameter(glodon::objectbuf::EntityRef nValue)
{
    ((Gfc2SurfaceTexture*)m_pEntity)->addParameter(nValue);
}

glodon::objectbuf::EntityRef NGfc2SurfaceTexture::getParameter(int nIndex)
{
