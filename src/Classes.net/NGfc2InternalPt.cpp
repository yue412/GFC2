...
void NGfc2InternalPt::setP(glodon::objectbuf::EntityRef nValue)
{
    ((Gfc2InternalPt*)m_pEntity)->setP(nValue);
}

glodon::objectbuf::EntityRef NGfc2InternalPt::getP()
{
...
void NGfc2InternalPt::setTVec(glodon::objectbuf::EntityRef nValue)
{
    ((Gfc2InternalPt*)m_pEntity)->setTVec(nValue);
}

glodon::objectbuf::EntityRef NGfc2InternalPt::getTVec()
{
...
void NGfc2InternalPt::setUV(glodon::objectbuf::EntityRef nValue)
{
    ((Gfc2InternalPt*)m_pEntity)->setUV(nValue);
}

glodon::objectbuf::EntityRef NGfc2InternalPt::getUV()
{
...
void NGfc2InternalPt::setST(glodon::objectbuf::EntityRef nValue)
{
    ((Gfc2InternalPt*)m_pEntity)->setST(nValue);
}

glodon::objectbuf::EntityRef NGfc2InternalPt::getST()
{
...
void NGfc2InternalPt::setUVDir(glodon::objectbuf::EntityRef nValue)
{
    ((Gfc2InternalPt*)m_pEntity)->setUVDir(nValue);
}

glodon::objectbuf::EntityRef NGfc2InternalPt::getUVDir()
{
...
void NGfc2InternalPt::setSTDir(glodon::objectbuf::EntityRef nValue)
{
    ((Gfc2InternalPt*)m_pEntity)->setSTDir(nValue);
}

glodon::objectbuf::EntityRef NGfc2InternalPt::getSTDir()
{
