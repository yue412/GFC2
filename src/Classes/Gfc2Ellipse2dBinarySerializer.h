#ifndef GFC2ELLIPSE2DBINARYSERIALIZER_H
#define GFC2ELLIPSE2DBINARYSERIALIZER_H

#include "Gfc2Curve2dBinarySerializer.h"

class Gfc2Ellipse2dBinarySerializer: public Gfc2Curve2dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2Ellipse2dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
