#ifndef GFC2SPIRALLINE2DBINARYSERIALIZER_H
#define GFC2SPIRALLINE2DBINARYSERIALIZER_H

#include "Gfc2Curve2dBinarySerializer.h"

class Gfc2SpiralLine2dBinarySerializer: public Gfc2Curve2dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2SpiralLine2dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
