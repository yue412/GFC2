#ifndef GFC2BILLDETAILBINARYSERIALIZER_H
#define GFC2BILLDETAILBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2BillDetailBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2BillDetailBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
