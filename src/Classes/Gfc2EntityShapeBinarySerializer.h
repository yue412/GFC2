#ifndef GFC2ENTITYSHAPEBINARYSERIALIZER_H
#define GFC2ENTITYSHAPEBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2EntityShapeBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2EntityShapeBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
