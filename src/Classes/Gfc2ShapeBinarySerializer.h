#ifndef GFC2SHAPEBINARYSERIALIZER_H
#define GFC2SHAPEBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2ShapeBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2ShapeBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
