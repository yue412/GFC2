...
OBJECTBUF_IMP_OBJECT(Gfc2NurbsCurve2dBinarySerializer,"Gfc2NurbsCurve2dB",0)

int Gfc2NurbsCurve2dBinarySerializer::byteSize(glodon::objectbuf::Entity* pEntity) const
{
...
void Gfc2NurbsCurve2dBinarySerializer::serializeWithCachedSizes(google::protobuf::io::CodedOutputStream* output, glodon::objectbuf::Entity* pEntity) const
{
    Gfc2NurbsCurve2d* pEnt = (Gfc2NurbsCurve2d*)pEntity;
...
google::protobuf::uint8* Gfc2NurbsCurve2dBinarySerializer::serializeWithCachedSizesToArray(google::protobuf::uint8* target, glodon::objectbuf::Entity* pEntity) const
{
    Gfc2NurbsCurve2d* pEnt = (Gfc2NurbsCurve2d*)pEntity;
...
glodon::objectbuf::EnParseFieldState Gfc2NurbsCurve2dBinarySerializer::parseField(google::protobuf::io::CodedInputStream* input, int nFieldNum, glodon::objectbuf::Entity* pEntity)
{
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
    ...
    if (nFieldNum == _FieldCache->_Gfc2NurbsCurve2d_Degree)
    {
        Gfc2Integer value;
    ...
    if (nFieldNum == _FieldCache->_Gfc2NurbsCurve2d_CtrlPts)
    {
        int nSize = 0;
    ...
    if (nFieldNum == _FieldCache->_Gfc2NurbsCurve2d_Knots)
    {
        int nSize = 0;
        DO_((google::protobuf::internal::WireFormatLite::ReadPrimitive<google::protobuf::int32, google::protobuf::internal::WireFormatLite::TYPE_INT32>(input, &nSize)));
        for(int i = 0; i < nSize; ++i)
