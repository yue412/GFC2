#ifndef GFC2AXISDATAITEMBINARYSERIALIZER_H
#define GFC2AXISDATAITEMBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2AxisDataItemBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2AxisDataItemBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
