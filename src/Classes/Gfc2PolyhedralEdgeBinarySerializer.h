#ifndef GFC2POLYHEDRALEDGEBINARYSERIALIZER_H
#define GFC2POLYHEDRALEDGEBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2PolyhedralEdgeBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2PolyhedralEdgeBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
