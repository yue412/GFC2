#ifndef GFC2POINTANGLEASSITAXISBINARYSERIALIZER_H
#define GFC2POINTANGLEASSITAXISBINARYSERIALIZER_H

#include "Gfc2AssitAxisBinarySerializer.h"

class Gfc2PointAngleAssitAxisBinarySerializer: public Gfc2AssitAxisBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2PointAngleAssitAxisBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
