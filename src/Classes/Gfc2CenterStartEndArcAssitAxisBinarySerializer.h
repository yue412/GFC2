#ifndef GFC2CENTERSTARTENDARCASSITAXISBINARYSERIALIZER_H
#define GFC2CENTERSTARTENDARCASSITAXISBINARYSERIALIZER_H

#include "Gfc2AssitAxisBinarySerializer.h"

class Gfc2CenterStartEndArcAssitAxisBinarySerializer: public Gfc2AssitAxisBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2CenterStartEndArcAssitAxisBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
