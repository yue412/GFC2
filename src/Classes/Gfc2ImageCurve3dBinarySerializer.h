#ifndef GFC2IMAGECURVE3DBINARYSERIALIZER_H
#define GFC2IMAGECURVE3DBINARYSERIALIZER_H

#include "Gfc2Curve3dBinarySerializer.h"

class Gfc2ImageCurve3dBinarySerializer: public Gfc2Curve3dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2ImageCurve3dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
