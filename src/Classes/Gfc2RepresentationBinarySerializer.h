#ifndef GFC2REPRESENTATIONBINARYSERIALIZER_H
#define GFC2REPRESENTATIONBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2RepresentationBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2RepresentationBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
