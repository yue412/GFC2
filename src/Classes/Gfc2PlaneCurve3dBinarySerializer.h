#ifndef GFC2PLANECURVE3DBINARYSERIALIZER_H
#define GFC2PLANECURVE3DBINARYSERIALIZER_H

#include "Gfc2Curve3dBinarySerializer.h"

class Gfc2PlaneCurve3dBinarySerializer: public Gfc2Curve3dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2PlaneCurve3dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
