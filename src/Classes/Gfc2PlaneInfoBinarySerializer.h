#ifndef GFC2PLANEINFOBINARYSERIALIZER_H
#define GFC2PLANEINFOBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2PlaneInfoBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2PlaneInfoBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
