#ifndef GFC2COMMONPOLYGONEXBINARYSERIALIZER_H
#define GFC2COMMONPOLYGONEXBINARYSERIALIZER_H

#include "Gfc2PolygonBinarySerializer.h"

class Gfc2CommonPolygonExBinarySerializer: public Gfc2PolygonBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2CommonPolygonExBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
