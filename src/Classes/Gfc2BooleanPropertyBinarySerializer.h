#ifndef GFC2BOOLEANPROPERTYBINARYSERIALIZER_H
#define GFC2BOOLEANPROPERTYBINARYSERIALIZER_H

#include "Gfc2PropertyBinarySerializer.h"

class Gfc2BooleanPropertyBinarySerializer: public Gfc2PropertyBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2BooleanPropertyBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
