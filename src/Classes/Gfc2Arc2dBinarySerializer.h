#ifndef GFC2ARC2DBINARYSERIALIZER_H
#define GFC2ARC2DBINARYSERIALIZER_H

#include "Gfc2Curve2dBinarySerializer.h"

class Gfc2Arc2dBinarySerializer: public Gfc2Curve2dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2Arc2dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
