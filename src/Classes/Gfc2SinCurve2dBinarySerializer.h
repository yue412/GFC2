#ifndef GFC2SINCURVE2DBINARYSERIALIZER_H
#define GFC2SINCURVE2DBINARYSERIALIZER_H

#include "Gfc2Curve2dBinarySerializer.h"

class Gfc2SinCurve2dBinarySerializer: public Gfc2Curve2dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2SinCurve2dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
