...
OBJECTBUF_IMP_OBJECT(Gfc2QuotaDetailBinarySerializer,"Gfc2QuotaDetailB",0)

int Gfc2QuotaDetailBinarySerializer::byteSize(glodon::objectbuf::Entity* pEntity) const
{
...
void Gfc2QuotaDetailBinarySerializer::serializeWithCachedSizes(google::protobuf::io::CodedOutputStream* output, glodon::objectbuf::Entity* pEntity) const
{
    Gfc2QuotaDetail* pEnt = (Gfc2QuotaDetail*)pEntity;
...
google::protobuf::uint8* Gfc2QuotaDetailBinarySerializer::serializeWithCachedSizesToArray(google::protobuf::uint8* target, glodon::objectbuf::Entity* pEntity) const
{
    Gfc2QuotaDetail* pEnt = (Gfc2QuotaDetail*)pEntity;
...
glodon::objectbuf::EnParseFieldState Gfc2QuotaDetailBinarySerializer::parseField(google::protobuf::io::CodedInputStream* input, int nFieldNum, glodon::objectbuf::Entity* pEntity)
{
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
    ...
    if (nFieldNum == _FieldCache->_Gfc2QuotaDetail_FloorNum)
    {
        Gfc2Integer value;
    ...
    if (nFieldNum == _FieldCache->_Gfc2QuotaDetail_EntityID)
    {
        Gfc2Integer value;
        DO_((google::protobuf::internal::WireFormatLite::ReadPrimitive<google::protobuf::int32, google::protobuf::internal::WireFormatLite::TYPE_INT32>(input, &value)));
    ...
    if (nFieldNum == _FieldCache->_Gfc2QuotaDetail_Unit)
    {
    ...
    if (nFieldNum == _FieldCache->_Gfc2QuotaDetail_Express)
    {
        glodon::objectbuf::EntityRef value;
        DO_((google::protobuf::internal::WireFormatLite::ReadPrimitive<google::protobuf::int32, google::protobuf::internal::WireFormatLite::TYPE_INT32>(input, &value)));
    ...
    if (nFieldNum == _FieldCache->_Gfc2QuotaDetail_Quantity)
    {
        glodon::objectbuf::EntityRef value;
        DO_((google::protobuf::internal::WireFormatLite::ReadPrimitive<google::protobuf::int32, google::protobuf::internal::WireFormatLite::TYPE_INT32>(input, &value)));
    ...
    if (nFieldNum == _FieldCache->_Gfc2QuotaDetail_Memo)
    {
        glodon::objectbuf::EntityRef value;
        DO_((google::protobuf::internal::WireFormatLite::ReadPrimitive<google::protobuf::int32, google::protobuf::internal::WireFormatLite::TYPE_INT32>(input, &value)));
        pEnt->setMemo(value);
