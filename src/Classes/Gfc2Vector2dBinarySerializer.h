#ifndef GFC2VECTOR2DBINARYSERIALIZER_H
#define GFC2VECTOR2DBINARYSERIALIZER_H

#include "Gfc2GeometryBinarySerializer.h"

class Gfc2Vector2dBinarySerializer: public Gfc2GeometryBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2Vector2dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
