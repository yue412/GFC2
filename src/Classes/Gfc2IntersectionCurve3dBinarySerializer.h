#ifndef GFC2INTERSECTIONCURVE3DBINARYSERIALIZER_H
#define GFC2INTERSECTIONCURVE3DBINARYSERIALIZER_H

#include "Gfc2Curve3dBinarySerializer.h"

class Gfc2IntersectionCurve3dBinarySerializer: public Gfc2Curve3dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2IntersectionCurve3dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
