...
OBJECTBUF_IMP_OBJECT(Gfc2PolyhedronBodyBinarySerializer,"Gfc2PolyhedronBodyB",0)

int Gfc2PolyhedronBodyBinarySerializer::byteSize(glodon::objectbuf::Entity* pEntity) const
{
...
void Gfc2PolyhedronBodyBinarySerializer::serializeWithCachedSizes(google::protobuf::io::CodedOutputStream* output, glodon::objectbuf::Entity* pEntity) const
{
    Gfc2PolyhedronBody* pEnt = (Gfc2PolyhedronBody*)pEntity;
...
google::protobuf::uint8* Gfc2PolyhedronBodyBinarySerializer::serializeWithCachedSizesToArray(google::protobuf::uint8* target, glodon::objectbuf::Entity* pEntity) const
{
    Gfc2PolyhedronBody* pEnt = (Gfc2PolyhedronBody*)pEntity;
...
glodon::objectbuf::EnParseFieldState Gfc2PolyhedronBodyBinarySerializer::parseField(google::protobuf::io::CodedInputStream* input, int nFieldNum, glodon::objectbuf::Entity* pEntity)
{
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
    ...
    if (nFieldNum == _FieldCache->_Gfc2PolyhedronBody_Faces)
    {
        int nSize = 0;
    ...
    if (nFieldNum == _FieldCache->_Gfc2PolyhedronBody_Vertexes)
    {
        int nSize = 0;
        DO_((google::protobuf::internal::WireFormatLite::ReadPrimitive<google::protobuf::int32, google::protobuf::internal::WireFormatLite::TYPE_INT32>(input, &nSize)));
        for(int i = 0; i < nSize; ++i)
