#ifndef GFC2FACESHAPE2DBINARYSERIALIZER_H
#define GFC2FACESHAPE2DBINARYSERIALIZER_H

#include "Gfc2Shape2dBinarySerializer.h"

class Gfc2FaceShape2dBinarySerializer: public Gfc2Shape2dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2FaceShape2dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
