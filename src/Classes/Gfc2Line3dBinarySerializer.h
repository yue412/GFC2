#ifndef GFC2LINE3DBINARYSERIALIZER_H
#define GFC2LINE3DBINARYSERIALIZER_H

#include "Gfc2Curve3dBinarySerializer.h"

class Gfc2Line3dBinarySerializer: public Gfc2Curve3dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2Line3dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
