...
OBJECTBUF_IMP_OBJECT(Gfc2HermiteCtrlPt2dTextSerializer,"Gfc2HermiteCtrlPt2dT",0)

std::string Gfc2HermiteCtrlPt2dTextSerializer::serialize(glodon::objectbuf::Entity* pEntity) const
{
...
glodon::objectbuf::EnParseFieldState Gfc2HermiteCtrlPt2dTextSerializer::parseField(const std::string& input, int nFieldNum, glodon::objectbuf::Entity* pEntity)
{
