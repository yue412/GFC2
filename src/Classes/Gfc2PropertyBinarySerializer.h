#ifndef GFC2PROPERTYBINARYSERIALIZER_H
#define GFC2PROPERTYBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2PropertyBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2PropertyBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
