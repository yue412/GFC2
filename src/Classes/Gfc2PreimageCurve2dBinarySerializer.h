#ifndef GFC2PREIMAGECURVE2DBINARYSERIALIZER_H
#define GFC2PREIMAGECURVE2DBINARYSERIALIZER_H

#include "Gfc2Curve2dBinarySerializer.h"

class Gfc2PreimageCurve2dBinarySerializer: public Gfc2Curve2dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2PreimageCurve2dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
