#ifndef GFC2RELDECOMPOSESBINARYSERIALIZER_H
#define GFC2RELDECOMPOSESBINARYSERIALIZER_H

#include "Gfc2RelationShipBinarySerializer.h"

class Gfc2RelDecomposesBinarySerializer: public Gfc2RelationShipBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2RelDecomposesBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
