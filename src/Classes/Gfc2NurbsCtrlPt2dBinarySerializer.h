#ifndef GFC2NURBSCTRLPT2DBINARYSERIALIZER_H
#define GFC2NURBSCTRLPT2DBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2NurbsCtrlPt2dBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2NurbsCtrlPt2dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
