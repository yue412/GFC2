...
OBJECTBUF_IMP_OBJECT(Gfc2CommonPolygonBinarySerializer,"Gfc2CommonPolygonB",0)

int Gfc2CommonPolygonBinarySerializer::byteSize(glodon::objectbuf::Entity* pEntity) const
{
...
void Gfc2CommonPolygonBinarySerializer::serializeWithCachedSizes(google::protobuf::io::CodedOutputStream* output, glodon::objectbuf::Entity* pEntity) const
{
    Gfc2CommonPolygon* pEnt = (Gfc2CommonPolygon*)pEntity;
...
google::protobuf::uint8* Gfc2CommonPolygonBinarySerializer::serializeWithCachedSizesToArray(google::protobuf::uint8* target, glodon::objectbuf::Entity* pEntity) const
{
    Gfc2CommonPolygon* pEnt = (Gfc2CommonPolygon*)pEntity;
...
glodon::objectbuf::EnParseFieldState Gfc2CommonPolygonBinarySerializer::parseField(google::protobuf::io::CodedInputStream* input, int nFieldNum, glodon::objectbuf::Entity* pEntity)
{
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
    ...
    if (nFieldNum == _FieldCache->_Gfc2CommonPolygon_Loops)
    {
        int nSize = 0;
