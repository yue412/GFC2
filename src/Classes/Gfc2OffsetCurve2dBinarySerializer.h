#ifndef GFC2OFFSETCURVE2DBINARYSERIALIZER_H
#define GFC2OFFSETCURVE2DBINARYSERIALIZER_H

#include "Gfc2Curve2dBinarySerializer.h"

class Gfc2OffsetCurve2dBinarySerializer: public Gfc2Curve2dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2OffsetCurve2dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
