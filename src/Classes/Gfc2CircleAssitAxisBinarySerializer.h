#ifndef GFC2CIRCLEASSITAXISBINARYSERIALIZER_H
#define GFC2CIRCLEASSITAXISBINARYSERIALIZER_H

#include "Gfc2AssitAxisBinarySerializer.h"

class Gfc2CircleAssitAxisBinarySerializer: public Gfc2AssitAxisBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2CircleAssitAxisBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
