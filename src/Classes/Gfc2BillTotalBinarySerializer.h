#ifndef GFC2BILLTOTALBINARYSERIALIZER_H
#define GFC2BILLTOTALBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2BillTotalBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2BillTotalBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
