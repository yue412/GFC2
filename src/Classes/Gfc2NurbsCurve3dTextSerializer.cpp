...
OBJECTBUF_IMP_OBJECT(Gfc2NurbsCurve3dTextSerializer,"Gfc2NurbsCurve3dT",0)

std::string Gfc2NurbsCurve3dTextSerializer::serialize(glodon::objectbuf::Entity* pEntity) const
{
...
glodon::objectbuf::EnParseFieldState Gfc2NurbsCurve3dTextSerializer::parseField(const std::string& input, int nFieldNum, glodon::objectbuf::Entity* pEntity)
{
