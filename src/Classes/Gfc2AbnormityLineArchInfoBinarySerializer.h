#ifndef GFC2ABNORMITYLINEARCHINFOBINARYSERIALIZER_H
#define GFC2ABNORMITYLINEARCHINFOBINARYSERIALIZER_H

#include "Gfc2BaseLineArcInfoBinarySerializer.h"

class Gfc2AbnormityLineArchInfoBinarySerializer: public Gfc2BaseLineArcInfoBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2AbnormityLineArchInfoBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
