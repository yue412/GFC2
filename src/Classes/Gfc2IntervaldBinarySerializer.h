#ifndef GFC2INTERVALDBINARYSERIALIZER_H
#define GFC2INTERVALDBINARYSERIALIZER_H

#include "Gfc2GeometryBinarySerializer.h"

class Gfc2IntervaldBinarySerializer: public Gfc2GeometryBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2IntervaldBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
