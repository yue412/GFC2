#ifndef GFC2INTERNALPTBINARYSERIALIZER_H
#define GFC2INTERNALPTBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2InternalPtBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2InternalPtBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
