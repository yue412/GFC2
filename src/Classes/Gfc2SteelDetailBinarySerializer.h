#ifndef GFC2STEELDETAILBINARYSERIALIZER_H
#define GFC2STEELDETAILBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2SteelDetailBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2SteelDetailBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
