#ifndef GFC2PARALLELASSITAXISBINARYSERIALIZER_H
#define GFC2PARALLELASSITAXISBINARYSERIALIZER_H

#include "Gfc2AssitAxisBinarySerializer.h"

class Gfc2ParallelAssitAxisBinarySerializer: public Gfc2AssitAxisBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2ParallelAssitAxisBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
