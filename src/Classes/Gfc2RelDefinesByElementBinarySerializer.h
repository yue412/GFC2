#ifndef GFC2RELDEFINESBYELEMENTBINARYSERIALIZER_H
#define GFC2RELDEFINESBYELEMENTBINARYSERIALIZER_H

#include "Gfc2RelDefinesBinarySerializer.h"

class Gfc2RelDefinesByElementBinarySerializer: public Gfc2RelDefinesBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2RelDefinesByElementBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
