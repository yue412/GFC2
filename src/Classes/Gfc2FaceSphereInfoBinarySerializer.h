#ifndef GFC2FACESPHEREINFOBINARYSERIALIZER_H
#define GFC2FACESPHEREINFOBINARYSERIALIZER_H

#include "Gfc2FaceInfoBinarySerializer.h"

class Gfc2FaceSphereInfoBinarySerializer: public Gfc2FaceInfoBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2FaceSphereInfoBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
