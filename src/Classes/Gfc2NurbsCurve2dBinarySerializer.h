#ifndef GFC2NURBSCURVE2DBINARYSERIALIZER_H
#define GFC2NURBSCURVE2DBINARYSERIALIZER_H

#include "Gfc2Curve2dBinarySerializer.h"

class Gfc2NurbsCurve2dBinarySerializer: public Gfc2Curve2dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2NurbsCurve2dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
