#ifndef GFC2QUOTADETAILBINARYSERIALIZER_H
#define GFC2QUOTADETAILBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2QuotaDetailBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2QuotaDetailBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
