#ifndef GFC2HERMITECTRLPT2DBINARYSERIALIZER_H
#define GFC2HERMITECTRLPT2DBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2HermiteCtrlPt2dBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2HermiteCtrlPt2dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
