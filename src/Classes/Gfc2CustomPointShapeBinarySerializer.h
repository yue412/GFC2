#ifndef GFC2CUSTOMPOINTSHAPEBINARYSERIALIZER_H
#define GFC2CUSTOMPOINTSHAPEBINARYSERIALIZER_H

#include "Gfc2SolidShapeBinarySerializer.h"

class Gfc2CustomPointShapeBinarySerializer: public Gfc2SolidShapeBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2CustomPointShapeBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
