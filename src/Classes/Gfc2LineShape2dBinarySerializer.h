#ifndef GFC2LINESHAPE2DBINARYSERIALIZER_H
#define GFC2LINESHAPE2DBINARYSERIALIZER_H

#include "Gfc2Shape2dBinarySerializer.h"

class Gfc2LineShape2dBinarySerializer: public Gfc2Shape2dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2LineShape2dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
