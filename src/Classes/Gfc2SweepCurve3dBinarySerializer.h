#ifndef GFC2SWEEPCURVE3DBINARYSERIALIZER_H
#define GFC2SWEEPCURVE3DBINARYSERIALIZER_H

#include "Gfc2Curve3dBinarySerializer.h"

class Gfc2SweepCurve3dBinarySerializer: public Gfc2Curve3dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2SweepCurve3dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
