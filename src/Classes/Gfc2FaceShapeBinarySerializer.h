#ifndef GFC2FACESHAPEBINARYSERIALIZER_H
#define GFC2FACESHAPEBINARYSERIALIZER_H

#include "Gfc2SolidShapeBinarySerializer.h"

class Gfc2FaceShapeBinarySerializer: public Gfc2SolidShapeBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2FaceShapeBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
