#ifndef GFC2SOLIDSHAPEBINARYSERIALIZER_H
#define GFC2SOLIDSHAPEBINARYSERIALIZER_H

#include "Gfc2Shape3dBinarySerializer.h"

class Gfc2SolidShapeBinarySerializer: public Gfc2Shape3dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2SolidShapeBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
