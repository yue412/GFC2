#ifndef GFC2EDGEBINARYSERIALIZER_H
#define GFC2EDGEBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2EdgeBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2EdgeBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
