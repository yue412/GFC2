#ifndef GFC2TORUSBINARYSERIALIZER_H
#define GFC2TORUSBINARYSERIALIZER_H

#include "Gfc2SurfaceBinarySerializer.h"

class Gfc2TorusBinarySerializer: public Gfc2SurfaceBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2TorusBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
