#ifndef GFC2SPIRALLINE3DBINARYSERIALIZER_H
#define GFC2SPIRALLINE3DBINARYSERIALIZER_H

#include "Gfc2Curve3dBinarySerializer.h"

class Gfc2SpiralLine3dBinarySerializer: public Gfc2Curve3dBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2SpiralLine3dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
