#ifndef GFC2HERMITECTRLPT3DBINARYSERIALIZER_H
#define GFC2HERMITECTRLPT3DBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2HermiteCtrlPt3dBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2HermiteCtrlPt3dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
