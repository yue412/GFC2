#ifndef GFC2COEDGEBINARYSERIALIZER_H
#define GFC2COEDGEBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2CoedgeBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2CoedgeBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
