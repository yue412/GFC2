#ifndef GFC2STRINGBINARYSERIALIZER_H
#define GFC2STRINGBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2StringBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2StringBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
