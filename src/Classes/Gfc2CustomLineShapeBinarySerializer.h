#ifndef GFC2CUSTOMLINESHAPEBINARYSERIALIZER_H
#define GFC2CUSTOMLINESHAPEBINARYSERIALIZER_H

#include "Gfc2SolidShapeBinarySerializer.h"

class Gfc2CustomLineShapeBinarySerializer: public Gfc2SolidShapeBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2CustomLineShapeBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
