#ifndef GFC2NURBSCTRLPT3DBINARYSERIALIZER_H
#define GFC2NURBSCTRLPT3DBINARYSERIALIZER_H

#include "glodon/objectbuf/EntityBinarySerializer.h"

class Gfc2NurbsCtrlPt3dBinarySerializer: public glodon::objectbuf::EntityBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2NurbsCtrlPt3dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
