#ifndef GFC2COORDINATES3DBINARYSERIALIZER_H
#define GFC2COORDINATES3DBINARYSERIALIZER_H

#include "Gfc2GeometryBinarySerializer.h"

class Gfc2Coordinates3dBinarySerializer: public Gfc2GeometryBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2Coordinates3dBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
