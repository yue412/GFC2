#ifndef GFC2GEOMETRYSHAPEBINARYSERIALIZER_H
#define GFC2GEOMETRYSHAPEBINARYSERIALIZER_H

#include "Gfc2ShapeBinarySerializer.h"

class Gfc2GeometryShapeBinarySerializer: public Gfc2ShapeBinarySerializer
{
OBJECTBUF_DEC_OBJECT(Gfc2GeometryShapeBinarySerializer,glodon::objectbuf::EntitySerializer)
public:
